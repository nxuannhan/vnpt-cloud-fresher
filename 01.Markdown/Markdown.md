...
- [2. Basic Syntax](#2-basic-syntax)
  ...
  3. [Line Breaks](#23-line-breaks)
  4. [Formatting](#24-formatting)
  5. [Blockquotes](#25-blockquotes)
  6. [Lists](#26-lists)
  7. [Code](#27-code)
  8. [Horizontal Rules](#28-horizontal-rules)
  9. [Link](#29-links)
  10. [Images](#210-images)
  11. [Tables](#211-tables)
  12. [Footnote](#212-footnote)
  13. [Heading IDs](#213-heading-ids)
  14. [Task Lists](#214-task-lists)

## **1. What is Markdown?**

Markdown là một ngôn ngữ đánh dấu (markup language) nhẹ, được sử dụng để thêm các thành phần định dạng vào các tài liệu văn bản.
